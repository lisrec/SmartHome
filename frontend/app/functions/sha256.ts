...
export class Sha256 {
    ...
    hash(msg, options) {
        ...
        for (var i=0; i<N; i++) {
            ...
            for (var t:number=0; t<64; t++) {
                var T1:any = h + this.Σ1(e) + this.Ch(e, f, g) + K[t] + W[t];
                var T2:any =     this.Σ0(a) + this.Maj(a, b, c);
                h = g;
                g = f;
                f = e;
                e = (d + T1) >>> 0;
        ...
        for (var h:any=0; h<H.length; h++) H[h] = ('00000000'+H[h].toString(16)).slice(-8);
